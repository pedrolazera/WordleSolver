@testset "minmax 4 - set 1" begin
	...
	max_depth = 1
	solver = WordleSolver.T_MinMax4(max_depth, W)

	@test WordleSolver.f_min(solver, W) == (3, 6)

end

@testset "minmax 4 - set 2" begin
	colors = [
...
@testset "minmax 4 - set 3" begin
	colors = [
		...
		[1,1,1,1,242,1,2] .+ 1, # E
		[0,2,2,3,0,242,3] .+ 1, # F -> [A, E] [B, C], [D, G]
		[0,1,1,1,1,1,242] .+ 1  # G
	]
